    ...
    <div className={classes.mainDiv}>
      ...
      >
        <Swiper
          ...
          onSlideChange={(swiper:any) => setCloudNumber(swiper.activeIndex + 1)} 
          spaceBetween={50}
          slidesPerView={1}
        >
          {data.map((e) => {
            return (
              <SwiperSlide className={classes.swiperHeader} key={e.id}>
                {e.text}
              </SwiperSlide>
            );
          })}
        ...
        {data.map((e) => {
          return (
            <div
              ...
              className={
                e.id === cloudNumber ? classes.swiperDiv : classes.activeSwiperDiv
              }
            ></div>
          );
        })}
